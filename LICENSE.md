...
All code in this project is licensed under the [MIT License](http://opensource.org/licenses/MIT).

# Data

Data gathered from government sources on baby names are licensed as follows:
...
The [terms](http://www.nationalarchives.gov.uk/doc/open-government-licence/) of the Open Government License are "[intended to be interoperable](http://wiki.creativecommons.org/Government_use_of_Creative_Commons#United_Kingdom)" with the Creative Commons CC-BY-SA license.
